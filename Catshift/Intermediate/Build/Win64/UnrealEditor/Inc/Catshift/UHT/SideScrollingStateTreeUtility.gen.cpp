...
#include "Catshift/Variant_SideScrolling/AI/SideScrollingStateTreeUtility.h"
...
CATSHIFT_API UScriptStruct* Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData();
CATSHIFT_API UScriptStruct* Z_Construct_UScriptStruct_FStateTreeGetPlayerTask();
...
class UScriptStruct* FStateTreeGetPlayerInstanceData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerInstanceData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData, (UObject*)Z_Construct_UPackage__Script_Catshift(), TEXT("StateTreeGetPlayerInstanceData"));
	}
...
class UScriptStruct* FStateTreeGetPlayerTask::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerTask.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStateTreeGetPlayerTask, (UObject*)Z_Construct_UPackage__Script_Catshift(), TEXT("StateTreeGetPlayerTask"));
	}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_valen_OneDrive_Documents_GitHub_Catshift_Catshift_Source_Catshift_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_Catshift_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FStateTreeGetPlayerInstanceData::StaticStruct, Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData_Statics::NewStructOps, TEXT("StateTreeGetPlayerInstanceData"), &Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerInstanceData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStateTreeGetPlayerInstanceData), 1732906988U) },
		{ FStateTreeGetPlayerTask::StaticStruct, Z_Construct_UScriptStruct_FStateTreeGetPlayerTask_Statics::NewStructOps, TEXT("StateTreeGetPlayerTask"), &Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerTask, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStateTreeGetPlayerTask), 2438245590U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_valen_OneDrive_Documents_GitHub_Catshift_Catshift_Source_Catshift_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_Catshift_1945432176(TEXT("/Script/Catshift"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Users_valen_OneDrive_Documents_GitHub_Catshift_Catshift_Source_Catshift_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_Catshift_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_valen_OneDrive_Documents_GitHub_Catshift_Catshift_Source_Catshift_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_Catshift_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
